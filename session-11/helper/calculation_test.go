...
func TestTableSum(t *testing.T) {
	tests := []struct {
		...
		{request: Sum(10, 10), expected: 20, errMsg: "Result has to be 20"},
		{request: Sum(20, 20), expected: 40, errMsg: "Result has to be 40"},
		{request: Sum(25, 25), expected: 50, errMsg: "Result has to be 50"},
	}
